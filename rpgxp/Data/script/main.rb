...
if !$NEKO_RUBY.nil?
  ...
  $key_0 = ControlKeyButton.new(Input::KB_TILDE, 20, 332, 0, 66, 66, false)
  ...
  $key_1 = ControlKeyButton.new(Input::KB_TAB, 100, 332, 0, 66, 66, false)
  ...
  $key_2 = ControlKeyButton.new(Input::KB_ENTER, 21, 400, 0, 66, 66, false)
  ...
  $key_3 = ControlKeyButton.new(Input::KB_ESCAPE, 100, 400, 0, 66, 66, false)
  ...
  $dpad8_0 = ControlDirection8.new(430, 269, 0, 224, 224, true)
